<div class="modal hide fade" id="login">
    <div class="modal-header">
        <button class="close" data-dismiss="modal"
                onclick="">×</button>
        <h2>用户登录</h2>
        <a href="javascript:void(0)" id="sticky_a"></a>
        <a href="javascript:void(0)" id="sticky_a1"></a>
        <a href="javascript:void(0)" id="sticky_a2"></a>
        <a href="javascript:void(0)" id="sticky_a3"></a>
        <a href="javascript:void(0)" id="sticky_a4"></a>
        <a href="javascript:void(0)" id="sticky_a5"></a>
    ...
    <div class="modal-body" data-backdrop="static">
        <form method="post" action="user?action=login" name="login_form"
              id="login_form">
            <div class="alert alert-info">请登录 江湖一隅 论坛，不要发布违法信息！</div>
            <div class="cnt_b">
                <div class="formRow">
